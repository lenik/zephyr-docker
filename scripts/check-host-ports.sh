...
# Usage:
#   CONTAINER_ID=zephyr \
#   HOST_BACKEND_HTTP_PORT=6786 HOST_BACKEND_HTTPS_PORT=6079 \
#   HOST_WEB_HTTP_PORT=8786 HOST_WEB_HTTPS_PORT=8079 \
#   HOST_MOBILE_WEB_PORT=18786 \
#   [NET_MODE=bridge|host] [PGPORT=5786] \
#   ./check-host-ports.sh
set -euo pipefail

ID="${CONTAINER_ID:-zephyr}"
HOST_BACKEND_HTTP_PORT="${HOST_BACKEND_HTTP_PORT:-6786}"
HOST_BACKEND_HTTPS_PORT="${HOST_BACKEND_HTTPS_PORT:-6079}"
HOST_WEB_HTTP_PORT="${HOST_WEB_HTTP_PORT:-8786}"
HOST_WEB_HTTPS_PORT="${HOST_WEB_HTTPS_PORT:-8079}"
HOST_MOBILE_WEB_PORT="${HOST_MOBILE_WEB_PORT:-18786}"
